...
<body>
  <div id="login" class="d-flex flex-column mx-auto my-5">
    ...
    <div id="input_id" class="d-flex flex-column">
      ...
      <span class="login_error pl-1 mt-2">아이디를 입력해주세요.</span>
    </div>
    ...
    <div id="input_password" class="d-flex flex-column mt-3">
      ...
      <span class="login_error pl-1 mt-2">비밀번호를 입력해주세요.</span>
    </div>
    ...
    <!-- btn_login -->
    <button id="btn_login" class="btn border rounded">로그인</button>
