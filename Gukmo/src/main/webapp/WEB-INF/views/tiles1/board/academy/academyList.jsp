...
<script type="text/javascript" src="<%=ctxPath %>/resources/js/hyunwoo/academyList.js" ></script>
  ...
  <div class="container mt-4">
    ...
    <div class="d-flex align-items-center border-top w-100">
      <%-- 학원 사진 --%>
      <div class="academy_img_box mr-2" onclick="location.href='<%=ctxPath %>/academy/academy.do?boardNum=${board.board_num}'">
      ...
      <div class="px-2 py-2 w-100">
        ...
        <%-- 글제목 --%>
        <a href="<%=ctxPath %>/academy/academy.do?boardNum=${board.board_num} " class="subject align-items-center my-2">
          ${board.subject}
        </a>
